...
const releaseId = process.env.WEBFORGE_RELEASE
if (!releaseId) throw new Error("WEBFORGE_RELEASE is required")

const version = process.env.WEBFORGE_VERSION
if (!version) throw new Error("WEBFORGE_VERSION is required")
...
const macxTarGz = "webforge-desktop-mac-x64.app.tar.gz"
const macaTarGz = "webforge-desktop-mac-arm64.app.tar.gz"
