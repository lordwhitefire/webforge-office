export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de WebForge",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de WebForge. ¿Quieres instalarla y reiniciar?",
