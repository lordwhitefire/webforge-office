  ...
  test("formats legacy and tagged config errors the same way", () => {
    const cases = [
      ...
      },
      {
        ...
        data: { path: "/tmp/webforge.jsonc", dir: ".webforge", suggestion: "opencode" },
        expected:
          'Directory ".webforge" in /tmp/webforge.jsonc is not valid. Rename the directory to "opencode" or remove it. This is a common typo.',
      },
      {
