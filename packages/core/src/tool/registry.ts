...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@webforge-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@webforge/v2/ToolRegistry") {}
