...
import { Entry, FileSystem, FindInput, Match } from "@webforge-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@webforge-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@webforge/v2/FileSystem") {}
