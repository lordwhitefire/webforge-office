...
import { Event } from "@webforge-ai/schema/project-directories"
import { ProjectCopy } from "@webforge-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@webforge/ProjectCopy") {}
