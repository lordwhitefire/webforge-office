...
- Effect plugins import `@webforge-ai/plugin/v2/effect`, not `@webforge-ai/core`.
- Public domain values use generated `@webforge-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@webforge-ai/plugin/v2/effect`.
