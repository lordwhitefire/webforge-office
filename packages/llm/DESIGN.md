...
> current private `@webforge-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@webforge-ai/ai`
...
- Secondary audience: WebForge and other durable agent runtimes
...
import { LLM } from "@webforge-ai/ai"
import { OpenAI } from "@webforge-ai/ai/providers/openai"
...
```ts
import { Message } from "@webforge-ai/ai"
...
import { LLM, Tool } from "@webforge-ai/ai"
...
WebForge and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@webforge-ai/ai/promise"
import { OpenAI } from "@webforge-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@webforge-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@webforge-ai/ai/provider"
...
@webforge-ai/ai/promise
  Promise/AsyncIterable LLM facade

@webforge-ai/ai/schema
  serializable domain schemas

@webforge-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@webforge-ai/ai/providers/openai
@webforge-ai/ai/providers/anthropic
@webforge-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@webforge-ai/llm`                      | `@webforge-ai/ai`                                           |
...
WebForge should migrate to `generateTurn` / `streamTurn`, preserving its durable
