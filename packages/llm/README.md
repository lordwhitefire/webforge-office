...
Schema-first LLM core for webforge. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@webforge-ai/llm"
import { OpenAI } from "@webforge-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@webforge-ai/llm/providers"
