...
const en = {
  "app.title": "AI Model Usage Rankings | WebForge Data",
  "app.description":
    "Explore WebForge Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "WebForge Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star WebForge on GitHub",
  "header.github": "GitHub",
  "header.tryWebForge": "Try WebForge",
  ...
  "home.topModelsDescription": "Usage of models across WebForge Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique WebForge Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | WebForge Data",
  "lab.description":
    "Compare {{lab}} models used in WebForge Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent WebForge usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in WebForge",
  ...
  "lab.shareOfUsage": "{{share}} of recent WebForge usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | WebForge Data",
  "model.description":
    "View {{model}} WebForge Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. WebForge Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's WebForge Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's WebForge Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No WebForge Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no WebForge Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "WebForge Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No WebForge Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent WebForge Go token volume.",
