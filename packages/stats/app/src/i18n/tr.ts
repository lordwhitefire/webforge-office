export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | WebForge Data",
  "app.description":
    "WebForge Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde WebForge Data logosu",
  ...
  "header.githubAria": "GitHub'da WebForge'a yıldız ver",
  "header.github": "GitHub",
  "header.tryWebForge": "WebForge'u dene",
  ...
  "footer.homeAria": "WebForge ana sayfası",
  ...
  "home.topModelsDescription": "WebForge Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz WebForge Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | WebForge Data",
  "lab.description":
    "WebForge Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son WebForge kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "WebForge'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son WebForge kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük WebForge token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | WebForge Data",
  "model.description":
    "{{model}} için WebForge Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda WebForge Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki WebForge Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki WebForge Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde WebForge Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son WebForge Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz WebForge Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük WebForge Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz WebForge Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama WebForge Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan WebForge Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen WebForge Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son WebForge Go token hacmine göre yakındaki modeller.",
