export const dict = {
  "app.title": "Rankingi użycia modeli AI | WebForge Data",
  "app.description":
    "Przeglądaj użycie WebForge Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny WebForge Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę WebForge na GitHub",
  "header.github": "GitHub",
  "header.tryWebForge": "Wypróbuj WebForge",
  ...
  "footer.homeAria": "Strona główna WebForge",
  ...
  "home.topModelsDescription": "Użycie modeli w WebForge Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy WebForge Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | WebForge Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w WebForge Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia WebForge.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w WebForge",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia WebForge",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów WebForge z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | WebForge Data",
  "model.description":
    "Zobacz dane użycia {{model}} w WebForge Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie WebForge Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu WebForge Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu WebForge Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia WebForge Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny WebForge Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia WebForge Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów WebForge Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy WebForge Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji WebForge Go.",
  ...
  "model.geoDescription": "Tokeny modelu WebForge Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne WebForge Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów WebForge Go.",
