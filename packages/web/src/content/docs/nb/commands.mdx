...
Opprett `.webforge/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom WebForge-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i WebForge [config](/docs/config):
...
- Per prosjekt: `.webforge/commands/`
...
WebForge inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
