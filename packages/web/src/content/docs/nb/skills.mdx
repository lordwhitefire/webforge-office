...
Agentferdigheter lar WebForge oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går webforge opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
webforge viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `webforge.json`:
