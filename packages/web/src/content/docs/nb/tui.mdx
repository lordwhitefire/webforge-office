---
title: TUI
description: Bruke webforge-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

WebForge gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre WebForge starter TUI for gjeldende katalog.
...
Når du bruker WebForge TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til WebForge. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt WebForge. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `webforge.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge WebForge venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `webforge.default`.
