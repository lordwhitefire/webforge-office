...
Utwórz `.webforge/commands/test.md`:
...
Możesz zdefiniować polecenia w `webforge.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji webforge:
...
- Globalnie: `~/.config/webforge/commands/`
- Na projekt: `.webforge/commands/`
...
webforge zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
