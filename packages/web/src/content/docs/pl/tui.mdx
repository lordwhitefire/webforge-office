---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala webforge.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

webforge zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie webforge uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI webforge, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do webforge. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij webforge. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `webforge.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo WebForge czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `webforge.default`.
