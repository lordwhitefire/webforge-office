---
title: Zen
description: Curated list of models provided by WebForge.
---
...
WebForge Zen is a list of tested and verified models provided by the WebForge team.

Zen works like any other provider in WebForge. You login to WebForge Zen and get
...
:::tip
We tested a select group of models and providers that work well with WebForge.
:::
...
WebForge Zen is an AI gateway that gives you access to these models.

---

## How it works

WebForge Zen works like any other provider in WebForge.

1. You sign in to **<a href={console}>WebForge Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select WebForge Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your WebForge config
uses the format `webforge/<model-id>`. For example, for GPT 5.5, you would
use `webforge/gpt-5.5` in your config.
...
- DeepSeek V4 Flash Free is available on WebForge for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on WebForge for a limited time. The team is using this time to collect feedback and improve the model.
- North Mini Code Free is available on WebForge for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on WebForge for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on WebForge for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with WebForge as well.
