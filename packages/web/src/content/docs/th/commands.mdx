...
สร้าง `.webforge/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ WebForge:
...
- ระดับผู้ใช้ (Global): `~/.config/webforge/commands/`
- ระดับโปรเจ็กต์: `.webforge/commands/`
...
WebForge มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
