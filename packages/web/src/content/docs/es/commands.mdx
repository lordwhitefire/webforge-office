...
Crear `.webforge/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración WebForge o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su WebForge [config](/docs/config):
...
- Por proyecto: `.webforge/commands/`
...
webforge incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
