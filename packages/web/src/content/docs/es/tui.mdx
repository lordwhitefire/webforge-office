---
title: TUI
description: Usando la interfaz de usuario del terminal WebForge.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

WebForge proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar WebForge se inicia TUI para el directorio actual.
...
Cuando utilice WebForge TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a WebForge. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de WebForge. _Alias_: `/quit`, `/q`
...
Esto es independiente de `webforge.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera WebForge después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `webforge.default`.
