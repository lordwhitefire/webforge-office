---
title: TUI
description: استخدام واجهة المستخدم TUI في WebForge.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر WebForge واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل WebForge إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة WebForge في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى WebForge. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من WebForge. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `webforge.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار WebForge بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `webforge.default`.
