...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في webforge.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في webforge مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.webforge/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/webforge/tools/`.
