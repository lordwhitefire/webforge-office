...
Brug den til at bygge integrasjoner og kontrollere webforge programmatisk.
...
Opret en forekomst av webforge:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `webforge.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av webforge, kan du oprete en klientforekomst for at koble til den:
