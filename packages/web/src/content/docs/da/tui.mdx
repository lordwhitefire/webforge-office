---
title: TUI
description: Brug af WebForge-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

WebForge giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre WebForge starter TUI for den nuværende mappe.
...
Når du bruger WebForge TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til WebForge. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut WebForge. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `webforge.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe WebForge venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `webforge.default`.
