...
description: Opret værktøjer, som LLM kan kalde webforge ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med webforges [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.webforge/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/webforge/tools/`.
