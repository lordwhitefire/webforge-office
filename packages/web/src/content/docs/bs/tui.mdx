---
title: TUI
description: Korištenje korisničkog interfejsa WebForge terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

WebForge pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje WebForge pokreće TUI za trenutni direktorij.
...
Kada koristite WebForge TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u WebForge. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz WebForge. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `webforge.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo WebForge čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `webforge.default`.
