...
Kreiraj `.webforge/commands/test.md`:
...
Možete dodati prilagođene komande kroz WebForge konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom WebForge [config](/docs/config):
...
- Globalno: `~/.config/webforge/commands/`
- Po projektu: `.webforge/commands/`
...
WebForge uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
