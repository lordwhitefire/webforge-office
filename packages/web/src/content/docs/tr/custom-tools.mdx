---
title: Özel Araçlar
description: LLM'un webforge'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. webforge'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.webforge/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/webforge/tools/` içine yerleştirerek.
