...
description: webforge dile özgü biçimlendiriciler kullanır.
---

webforge, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

webforge, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, webforge bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

webforge bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri webforge yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
