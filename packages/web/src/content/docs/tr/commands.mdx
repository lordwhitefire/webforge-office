...
`.webforge/commands/test.md` oluştur:
...
webforge işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

webforge [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/webforge/commands/`
- Proje başına: `.webforge/commands/`
...
webforge, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
