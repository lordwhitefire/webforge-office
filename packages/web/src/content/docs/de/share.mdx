---
title: Teilen
description: Teile WebForge-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu WebForge-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht WebForge Folgendes:
...
WebForge hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt WebForge den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`webforge.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du webforge in deiner Organisation einsetzt.
