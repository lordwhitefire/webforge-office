---
title: SDK
description: Typsicherer JS-Client fuer den webforge-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das webforge JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und webforge programmatisch steuern.
...
Erstelle eine webforge-Instanz:
...
`webforge.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn webforge bereits laeuft, kannst du nur einen Client erstellen und verbinden:
