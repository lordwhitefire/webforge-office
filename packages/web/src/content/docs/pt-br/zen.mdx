---
title: Zen
description: Lista selecionada de modelos fornecidos pelo WebForge.
---
...
O WebForge Zen é uma lista de modelos testados e verificados fornecidos pela equipe do WebForge.

O Zen funciona como qualquer outro provedor no WebForge. Você faz login no WebForge Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o WebForge.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o WebForge.
:::
...
O WebForge Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O WebForge Zen funciona como qualquer outro provedor no WebForge.

1. Você faz login no **<a href={console}>WebForge Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona WebForge Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do WebForge usa o formato `webforge/<model-id>`. Por exemplo, para GPT 5.5, você usaria `webforge/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no WebForge por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no WebForge por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no WebForge por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no WebForge por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no WebForge por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o WebForge também.
