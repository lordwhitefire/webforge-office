...
import { IconWebforge } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "webforge/session/message-v2"
import type { Message } from "webforge/session/message"
import type { Session } from "webforge/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.webforge_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.webforge_name}>
                    <IconWebforge width={16} height={16} />
                  </div>
