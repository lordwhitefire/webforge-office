...
const GLOBAL_STORAGE = "webforge.global.dat"
const WINDOW_STORAGE = "webforge.window"
const LOCAL_PREFIX = "webforge."
...
function workspaceStorage(dir: string) {
  ...
  return `webforge.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `webforge.draft.${head}.${sum}.dat`
}
