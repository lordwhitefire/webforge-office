...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "webforge", key: "dialog.provider.webforge.note" },
  { match: (id: string) => id === "webforge-go", key: "dialog.provider.webforgeGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "webforge" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "webforge" || item.id === "webforge-go"}>
