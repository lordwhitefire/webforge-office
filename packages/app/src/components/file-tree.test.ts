...
beforeAll(async () => {
  ...
  mock.module("@webforge-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@webforge-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@webforge-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@webforge-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
