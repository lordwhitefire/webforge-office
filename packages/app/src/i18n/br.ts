export const dict = {
  ...
  "dialog.provider.webforge.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.webforge.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.webforgeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo WebForge",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no WebForge.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.webforgeZen.visit.prefix": "Visite ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no WebForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no WebForge.",
  ...
  "dialog.plugins.empty": "Plugins configurados em webforge.json",
  ...
  "dialog.server.description": "Trocar para qual servidor WebForge este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingWebforge": "Verificando o WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "Verificando o WebForge em {{distro}}...",
  "wsl.onboarding.updatingWebforge": "Atualizando o WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "Atualizando o WebForge em {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "Atualize o WebForge em {{distro}}.",
  "wsl.onboarding.updateWebforge": "Atualizar o WebForge",
  "wsl.onboarding.webforgeReadyIn": "O WebForge está pronto em {{distro}}.",
  "wsl.onboarding.webforgeReady": "O WebForge está pronto.",
  "wsl.onboarding.installWebforgeIn": "Instale o WebForge em {{distro}}.",
  "wsl.onboarding.installWebforge": "Instalar o WebForge",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o WebForge possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O WebForge não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o WebForge novamente.",
  ...
  "toast.update.description": "Uma nova versão do WebForge ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do WebForge",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (webforge.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: WebForge ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "WebForge inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor WebForge dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do WebForge",
  ...
  "settings.general.row.appearance.description": "Personalize como o WebForge aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o WebForge segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o WebForge é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o WebForge iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do WebForge.",
