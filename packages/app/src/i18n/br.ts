export const dict = {
  ...
  "wsl.onboarding.webforgeReadyIn": "O OpenCode está pronto em {{distro}}.",
  "wsl.onboarding.webforgeReady": "O OpenCode está pronto.",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "OpenCode não instalado",
