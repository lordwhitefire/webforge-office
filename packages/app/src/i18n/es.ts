export const dict = {
  ...
  "wsl.onboarding.webforgeReadyIn": "OpenCode está listo en {{distro}}.",
  "wsl.onboarding.webforgeReady": "OpenCode está listo.",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "OpenCode no está instalado",
