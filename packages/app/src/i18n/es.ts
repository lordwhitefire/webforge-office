export const dict = {
  ...
  "dialog.provider.webforge.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.webforge.tagline": "Modelos optimizados y fiables",
  "dialog.provider.webforgeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por WebForge",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en WebForge.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.webforgeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.webforgeZen.visit.prefix": "Visita ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en WebForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en WebForge.",
  ...
  "dialog.plugins.empty": "Plugins configurados en webforge.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de WebForge se conecta esta app.",
  ...
  "wsl.onboarding.checkingWebforge": "Comprobando WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "Comprobando WebForge en {{distro}}...",
  "wsl.onboarding.updatingWebforge": "Actualizando WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "Actualizando WebForge en {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "Actualiza WebForge en {{distro}}.",
  "wsl.onboarding.updateWebforge": "Actualizar WebForge",
  "wsl.onboarding.webforgeReadyIn": "WebForge está listo en {{distro}}.",
  "wsl.onboarding.webforgeReady": "WebForge está listo.",
  "wsl.onboarding.installWebforgeIn": "Instala WebForge en {{distro}}.",
  "wsl.onboarding.installWebforge": "Instalar WebForge",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que WebForge pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "WebForge no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir WebForge.",
  ...
  "toast.update.description": "Una nueva versión de WebForge ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de WebForge",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (webforge.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, WebForge no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "WebForge incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor WebForge dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para WebForge",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve WebForge en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si WebForge sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de WebForge.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia WebForge",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de WebForge.",
