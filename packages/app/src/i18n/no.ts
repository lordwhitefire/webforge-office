...
export const dict = {
  ...
  "dialog.provider.webforge.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.webforge.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.webforgeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av WebForge",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i WebForge.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.webforgeZen.visit.prefix": "Besøk ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i WebForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i WebForge.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i webforge.json",
  ...
  "dialog.server.description": "Bytt hvilken WebForge-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av WebForge ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til WebForge-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (webforge.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at WebForge ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "WebForge inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør WebForge-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for WebForge",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan WebForge ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om WebForge skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan WebForge er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når WebForge starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av WebForge.",
  ...
  "wsl.onboarding.checkingWebforge": "Sjekker WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "Sjekker WebForge i {{distro}}...",
  "wsl.onboarding.updatingWebforge": "Oppdaterer WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "Oppdaterer WebForge i {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "Oppdater WebForge i {{distro}}.",
  "wsl.onboarding.updateWebforge": "Oppdater WebForge",
  "wsl.onboarding.webforgeReadyIn": "WebForge er klar i {{distro}}.",
  "wsl.onboarding.webforgeReady": "WebForge er klar.",
  "wsl.onboarding.installWebforgeIn": "Installer WebForge i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før WebForge kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "WebForge kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter WebForge på nytt.",
