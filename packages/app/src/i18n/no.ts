...
export const dict = {
  ...
  "wsl.onboarding.webforgeReadyIn": "OpenCode er klar i {{distro}}.",
  "wsl.onboarding.webforgeReady": "OpenCode er klar.",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "OpenCode er ikke installert",
