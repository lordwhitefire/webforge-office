export const dict = {
  ...
  "dialog.provider.webforge.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.webforge.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.webforgeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af WebForge",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i WebForge.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.webforgeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.webforgeZen.visit.prefix": "Besøg ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i WebForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i WebForge.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i webforge.json",
  ...
  "dialog.server.description": "Skift hvilken WebForge-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingWebforge": "Tjekker WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "Tjekker WebForge i {{distro}}...",
  "wsl.onboarding.updatingWebforge": "Opdaterer WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "Opdaterer WebForge i {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "Opdater WebForge i {{distro}}.",
  "wsl.onboarding.updateWebforge": "Opdater WebForge",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før WebForge kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "WebForge kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter WebForge igen.",
  ...
  "toast.update.description": "En ny version af WebForge ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til WebForge-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (webforge.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, WebForge understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "WebForge inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør WebForge-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for WebForge",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan WebForge ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om WebForge følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan WebForge er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når WebForge starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af WebForge.",
