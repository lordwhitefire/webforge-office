export const dict = {
  ...
  "wsl.onboarding.webforgeReadyIn": "OpenCode جاهز في {{distro}}.",
  "wsl.onboarding.webforgeReady": "OpenCode جاهز.",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "OpenCode غير مثبت",
