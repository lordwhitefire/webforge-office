export const dict = {
  ...
  "dialog.provider.webforge.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.webforge.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.webforgeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من WebForge",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في WebForge.",
  ...
  "provider.connect.webforgeZen.line1":
    "يمنحك WebForge Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.webforgeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في WebForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في WebForge.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في webforge.json",
  ...
  "dialog.server.description": "تبديل خادم WebForge الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingWebforge": "جارٍ التحقق من WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "جارٍ التحقق من WebForge في {{distro}}...",
  "wsl.onboarding.updatingWebforge": "جارٍ تحديث WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "جارٍ تحديث WebForge في {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "حدّث WebForge في {{distro}}.",
  "wsl.onboarding.updateWebforge": "تحديث WebForge",
  "wsl.onboarding.webforgeReadyIn": "WebForge جاهز في {{distro}}.",
  "wsl.onboarding.webforgeReady": "WebForge جاهز.",
  "wsl.onboarding.installWebforgeIn": "ثبّت WebForge في {{distro}}.",
  "wsl.onboarding.installWebforge": "تثبيت WebForge",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن WebForge من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على WebForge التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح WebForge.",
  ...
  "toast.update.description": "نسخة جديدة من WebForge ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق WebForge",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (webforge.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن WebForge لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن WebForge نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم WebForge داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ WebForge",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور WebForge على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان WebForge يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة WebForge.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل WebForge",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من WebForge.",
