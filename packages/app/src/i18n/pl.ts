export const dict = {
  ...
  "dialog.provider.webforge.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.webforge.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.webforgeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez WebForge",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w WebForge.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.webforgeZen.visit.prefix": "Odwiedź ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w WebForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w WebForge.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w webforge.json",
  ...
  "dialog.server.description": "Przełącz serwer WebForge, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingWebforge": "Sprawdzanie WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "Sprawdzanie WebForge w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingWebforge": "Aktualizowanie WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "Aktualizowanie WebForge w dystrybucji {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "Zaktualizuj WebForge w dystrybucji {{distro}}.",
  "wsl.onboarding.updateWebforge": "Zaktualizuj WebForge",
  "wsl.onboarding.webforgeReadyIn": "WebForge jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.webforgeReady": "WebForge jest gotowy.",
  "wsl.onboarding.installWebforgeIn": "Zainstaluj WebForge w dystrybucji {{distro}}.",
  "wsl.onboarding.installWebforge": "Zainstaluj WebForge",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim WebForge będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "WebForge nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz WebForge.",
  ...
  "toast.update.description": "Nowa wersja WebForge ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu WebForge",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (webforge.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: WebForge nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "WebForge zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer WebForge wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla WebForge",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd WebForge na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy WebForge ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw WebForge.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania WebForge",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji WebForge.",
