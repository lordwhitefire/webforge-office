export const dict = {
  ...
  "dialog.provider.webforge.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.webforge.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.webforgeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje WebForge",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u WebForge-u.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.webforgeZen.visit.prefix": "Posjeti ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u WebForge-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u WebForge-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u webforge.json",
  ...
  "dialog.server.description": "Promijeni na koji se WebForge server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingWebforge": "Provjera WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "Provjera WebForge u distribuciji {{distro}}...",
  "wsl.onboarding.updatingWebforge": "Ažuriranje WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "Ažuriranje WebForge u distribuciji {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "Ažuriraj WebForge u distribuciji {{distro}}.",
  "wsl.onboarding.updateWebforge": "Ažuriraj WebForge",
  "wsl.onboarding.webforgeReadyIn": "WebForge je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.webforgeReady": "WebForge je spreman.",
  "wsl.onboarding.installWebforgeIn": "Instaliraj WebForge u distribuciji {{distro}}.",
  "wsl.onboarding.installWebforge": "Instaliraj WebForge",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi WebForge mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "WebForge nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori WebForge.",
  ...
  "toast.update.description": "Nova verzija WebForge-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku WebForge timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (webforge.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: WebForge još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "WebForge uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni WebForge server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u WebForge-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako WebForge izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li WebForge prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu WebForge-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se WebForge pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju WebForge-a.",
