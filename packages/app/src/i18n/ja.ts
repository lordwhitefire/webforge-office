export const dict = {
  ...
  "wsl.onboarding.webforgeReadyIn": "{{distro}}内のOpenCodeの準備ができました。",
  "wsl.onboarding.webforgeReady": "OpenCodeの準備ができました。",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "OpenCodeがインストールされていません",
