export const dict = {
  ...
  "dialog.provider.webforge.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.webforge.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.webforgeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "WebForgeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、WebForgeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.webforgeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.webforgeZen.visit.prefix": " ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してWebForgeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、WebForgeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "webforge.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するWebForgeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingWebforge": "WebForgeを確認中...",
  "wsl.onboarding.checkingWebforgeIn": "{{distro}}内のWebForgeを確認中...",
  "wsl.onboarding.updatingWebforge": "WebForgeを更新中...",
  "wsl.onboarding.updatingWebforgeIn": "{{distro}}内のWebForgeを更新中...",
  "wsl.onboarding.updateWebforgeIn": "{{distro}}内のWebForgeを更新してください。",
  "wsl.onboarding.updateWebforge": "WebForgeを更新",
  "wsl.onboarding.webforgeReadyIn": "{{distro}}内のWebForgeの準備ができました。",
  "wsl.onboarding.webforgeReady": "WebForgeの準備ができました。",
  "wsl.onboarding.installWebforgeIn": "{{distro}}にWebForgeをインストールしてください。",
  "wsl.onboarding.installWebforge": "WebForgeをインストール",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForgeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WebForgeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、WebForgeをもう一度開いてください。",
  ...
  "toast.update.description": "WebForgeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをWebForgeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (webforge.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: WebForgeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "WebForgeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でWebForgeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "WebForgeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのWebForgeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "WebForgeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "WebForgeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "WebForge の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "WebForge は最新バージョンです。",
