export const dict = {
  ...
  "dialog.provider.webforge.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.webforge.tagline": "Reliable optimized models",
  "dialog.provider.webforgeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by WebForge",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in WebForge.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.webforgeZen.line1":
    "WebForge Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.webforgeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.webforgeZen.visit.prefix": "Visit ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in WebForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in WebForge.",
  ...
  "dialog.plugins.empty": "Plugins configured in webforge.json",
  ...
  "dialog.server.description": "Switch which WebForge server this app connects to.",
  ...
  "wsl.onboarding.checkingWebforge": "Checking WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "Checking WebForge in {{distro}}...",
  "wsl.onboarding.updatingWebforge": "Updating WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "Updating WebForge in {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "Update WebForge in {{distro}}.",
  "wsl.onboarding.updateWebforge": "Update WebForge",
  "wsl.onboarding.webforgeReadyIn": "WebForge is ready in {{distro}}.",
  "wsl.onboarding.webforgeReady": "WebForge is ready.",
  "wsl.onboarding.installWebforgeIn": "Install WebForge in {{distro}}.",
  "wsl.onboarding.installWebforge": "Install WebForge",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before WebForge can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "WebForge could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen WebForge.",
  ...
  "toast.update.description": "A new version of WebForge ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the WebForge team",
  ...
  "error.chain.checkConfig": "Check your config (webforge.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, WebForge does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "WebForge includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the WebForge server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for WebForge",
  ...
  "settings.general.row.appearance.description": "Customise how WebForge looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether WebForge follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how WebForge is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when WebForge launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of WebForge.",
