...
export const dict = {
  ...
  "dialog.provider.webforge.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.webforge.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.webforgeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "WebForge tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve WebForge'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.webforgeZen.visit.prefix": "",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak WebForge'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak WebForge'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler webforge.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi WebForge sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingWebforge": "WebForge kontrol ediliyor...",
  "wsl.onboarding.checkingWebforgeIn": "{{distro}} içinde WebForge kontrol ediliyor...",
  "wsl.onboarding.updatingWebforge": "WebForge güncelleniyor...",
  "wsl.onboarding.updatingWebforgeIn": "{{distro}} içinde WebForge güncelleniyor...",
  "wsl.onboarding.updateWebforgeIn": "{{distro}} içindeki WebForge'u güncelleyin.",
  "wsl.onboarding.updateWebforge": "WebForge'u güncelle",
  "wsl.onboarding.webforgeReadyIn": "{{distro}} içinde WebForge hazır.",
  "wsl.onboarding.webforgeReady": "WebForge hazır.",
  "wsl.onboarding.installWebforgeIn": "WebForge'u {{distro}} içine kurun.",
  "wsl.onboarding.installWebforge": "WebForge'u kur",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WebForge'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "WebForge bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından WebForge'u tekrar açın.",
  ...
  "toast.update.description": "WebForge'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı WebForge ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (webforge.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: WebForge henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "WebForge ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "WebForge Masaüstü",
  ...
  "settings.desktop.wsl.description": "WebForge sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "WebForge'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "WebForge'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "WebForge'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "WebForge'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "WebForge başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "WebForge'un en son sürümünü kullanıyorsunuz.",
