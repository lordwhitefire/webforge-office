export const dict = {
  ...
  "wsl.onboarding.webforgeReadyIn": "OpenCode est prêt dans {{distro}}.",
  "wsl.onboarding.webforgeReady": "OpenCode est prêt.",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "OpenCode non installé",
