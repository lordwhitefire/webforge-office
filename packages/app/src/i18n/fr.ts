export const dict = {
  ...
  "dialog.provider.webforge.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.webforge.tagline": "Modèles optimisés et fiables",
  "dialog.provider.webforgeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par WebForge",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans WebForge.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.webforgeZen.visit.prefix": "Visitez ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans WebForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans WebForge.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans webforge.json",
  ...
  "dialog.server.description": "Changez le serveur WebForge auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingWebforge": "Vérification d'WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "Vérification d'WebForge dans {{distro}}...",
  "wsl.onboarding.updatingWebforge": "Mise à jour d'WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "Mise à jour d'WebForge dans {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "Mettez à jour WebForge dans {{distro}}.",
  "wsl.onboarding.updateWebforge": "Mettre à jour WebForge",
  "wsl.onboarding.webforgeReadyIn": "WebForge est prêt dans {{distro}}.",
  "wsl.onboarding.webforgeReady": "WebForge est prêt.",
  "wsl.onboarding.installWebforgeIn": "Installez WebForge dans {{distro}}.",
  "wsl.onboarding.installWebforge": "Installer WebForge",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'WebForge puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "WebForge n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez WebForge.",
  ...
  "toast.update.description":
    "Une nouvelle version d'WebForge ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe WebForge",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (webforge.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'WebForge ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "WebForge inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur WebForge dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour WebForge",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'WebForge sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si WebForge suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'WebForge.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'WebForge",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'WebForge.",
