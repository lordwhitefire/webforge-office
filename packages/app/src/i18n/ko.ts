export const dict = {
  ...
  "wsl.onboarding.webforgeReadyIn": "{{distro}}에서 OpenCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.webforgeReady": "OpenCode가 준비되었습니다.",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "OpenCode가 설치되지 않음",
