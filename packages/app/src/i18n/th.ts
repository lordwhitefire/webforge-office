export const dict = {
  ...
  "wsl.onboarding.webforgeReadyIn": "OpenCode พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.webforgeReady": "OpenCode พร้อมใช้งานแล้ว.",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "ยังไม่ได้ติดตั้ง OpenCode",
