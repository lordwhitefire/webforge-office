...
export const dict = {
  ...
  "dialog.provider.webforge.note": "使用 OpenCode Zen 或 API 密钥连接",
  ...
  "provider.connect.webforgeZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "wsl.onboarding.webforgeReadyIn": "{{distro}} 中的 OpenCode 已就绪。",
  "wsl.onboarding.webforgeReady": "OpenCode 已就绪。",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "未安装 OpenCode",
