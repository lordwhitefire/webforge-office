...
export const dict = {
  ...
  "dialog.provider.webforge.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.webforge.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.webforgeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von WebForge",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in WebForge zu nutzen.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.webforgeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.webforgeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in WebForge zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in WebForge zu nutzen.",
  ...
  "dialog.plugins.empty": "In webforge.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den WebForge-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.webforge": "WebForge",
  ...
  "wsl.onboarding.checkingWebforge": "WebForge wird geprüft...",
  "wsl.onboarding.checkingWebforgeIn": "WebForge in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingWebforge": "WebForge wird aktualisiert...",
  "wsl.onboarding.updatingWebforgeIn": "WebForge in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateWebforgeIn": "Aktualisieren Sie WebForge in {{distro}}.",
  "wsl.onboarding.updateWebforge": "WebForge aktualisieren",
  "wsl.onboarding.webforgeReadyIn": "WebForge ist in {{distro}} bereit.",
  "wsl.onboarding.webforgeReady": "WebForge ist bereit.",
  "wsl.onboarding.installWebforgeIn": "Installieren Sie WebForge in {{distro}}.",
  "wsl.onboarding.installWebforge": "WebForge installieren",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor WebForge einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "WebForge konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann WebForge erneut.",
  ...
  "toast.update.description": "Eine neue Version von WebForge ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem WebForge-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (webforge.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: WebForge unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "WebForge enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "WebForge Desktop",
  ...
  "settings.desktop.wsl.description": "WebForge-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für WebForge ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie WebForge auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob WebForge dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von WebForge anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von WebForge automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von WebForge.",
