export const dict = {
  ...
  "dialog.provider.webforge.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.webforge.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.webforgeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від WebForge",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у WebForge.",
  ...
  "provider.connect.webforgeZen.line1":
    "WebForge Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.webforgeZen.visit.prefix": "Відвідайте ",
  "provider.connect.webforgeZen.visit.link": "opencode.ai/zen",
  "provider.connect.webforgeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у WebForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у WebForge.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в webforge.json",
  ...
  "dialog.server.description": "Перемкніть сервер WebForge, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingWebforge": "Перевірка WebForge...",
  "wsl.onboarding.checkingWebforgeIn": "Перевірка WebForge у {{distro}}...",
  "wsl.onboarding.updatingWebforge": "Оновлення WebForge...",
  "wsl.onboarding.updatingWebforgeIn": "Оновлення WebForge у {{distro}}...",
  "wsl.onboarding.updateWebforgeIn": "Оновіть WebForge у {{distro}}.",
  "wsl.onboarding.updateWebforge": "Оновити WebForge",
  "wsl.onboarding.webforgeReadyIn": "WebForge готовий до роботи у {{distro}}.",
  "wsl.onboarding.webforgeReady": "WebForge готовий до роботи.",
  "wsl.onboarding.installWebforgeIn": "Встановіть WebForge у {{distro}}.",
  "wsl.onboarding.installWebforge": "Встановити WebForge",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "WebForge не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в WebForge потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "WebForge не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте WebForge.",
  ...
  "toast.update.description": "Нова версія WebForge ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді WebForge",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (webforge.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, WebForge ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "WebForge містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер WebForge всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу WebForge",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд WebForge на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи WebForge використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему WebForge.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску WebForge",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію WebForge.",
