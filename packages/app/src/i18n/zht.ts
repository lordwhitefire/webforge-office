...
export const dict = {
  ...
  "provider.connect.webforgeZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "wsl.onboarding.webforgeReadyIn": "{{distro}} 中的 OpenCode 已就緒。",
  "wsl.onboarding.webforgeReady": "OpenCode 已就緒。",
  ...
  "wsl.onboarding.distroStatus.webforgeMissing": "未安裝 OpenCode",
