...
import { compile, emitEffectImported, emitPromise, write } from "@webforge-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "WebForgeEventEncoded",
              import: 'import type { WebForgeEventEncoded } from "@webforge-ai/protocol/groups/event"',
            },
          },
        }),
