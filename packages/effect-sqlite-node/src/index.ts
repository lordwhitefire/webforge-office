...
export const TypeId: TypeId = "~@webforge-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@webforge-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@webforge-ai/effect-sqlite-node/NodeSqliteClient")
