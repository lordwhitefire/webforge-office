...
import { registerWebforgeSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@webforge-ai/sdk/v2"
...
import { WEBFORGE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useWebforgeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.WEBFORGE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
