...
class Database extends Context.Service<Database, DatabaseShape>()("@webforge/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@webforge/example/UserStore") {
