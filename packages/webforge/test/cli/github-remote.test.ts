...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/webforge.git")).toEqual({ owner: "sst", repo: "webforge" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/webforge")).toEqual({ owner: "sst", repo: "webforge" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/webforge.git")).toEqual({ owner: "sst", repo: "webforge" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/webforge")).toEqual({ owner: "sst", repo: "webforge" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/webforge.git")).toEqual({ owner: "sst", repo: "webforge" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/webforge")).toEqual({ owner: "sst", repo: "webforge" })
})
