...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips webforge-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-webforge-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-webforge-directory")).toBeNull()
      expect(result.get("x-webforge-workspace")).toBeNull()
