...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders WEBFORGE_CALLER", () => {
    process.env["WEBFORGE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode WEBFORGE_CALLER", () => {
    process.env["WEBFORGE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown WEBFORGE_CALLER", () => {
    process.env["WEBFORGE_CALLER"] = "unknown"
