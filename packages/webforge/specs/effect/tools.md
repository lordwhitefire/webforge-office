...
Practical reference for the current tool-migration state in `packages/webforge`.
...
Tool tests should use the existing Effect helpers in `packages/webforge/test/lib/effect.ts`:
