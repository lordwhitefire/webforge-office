...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/webforge`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy webforge service removed
