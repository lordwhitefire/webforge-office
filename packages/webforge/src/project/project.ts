...
import { ProjectDirectoryTable, ProjectTable } from "@webforge-ai/core/project/sql"
import { ProjectDirectories } from "@webforge-ai/core/project/directories"
...
import { which } from "@webforge-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@webforge/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.WEBFORGE_FAKE_VCS)
