...
import { makeApi } from "@webforge-ai/protocol/api"
import { LocationMiddleware } from "@webforge-ai/server/location"
import { SessionLocationMiddleware } from "@webforge-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("webforge-root")
...
export const InstanceHttpApi = HttpApi.make("webforge-instance")
...
export const WebForgeHttpApi = HttpApi.make("webforge")
