...
>()("@webforge/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@webforge/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.WEBFORGE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.WEBFORGE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-webforge-directory"] || process.cwd()
}
