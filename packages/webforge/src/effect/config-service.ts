 ...
 *   "@webforge/ServerAuthConfig",
 *   {
 *     password: Config.string("WEBFORGE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("WEBFORGE_SERVER_USERNAME").pipe(Config.withDefault("webforge")),
 *   },
 * ) {}
 *
