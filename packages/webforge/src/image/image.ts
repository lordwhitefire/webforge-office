...
export class Service extends Context.Service<Service, Interface>()("@webforge/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __WEBFORGE_PHOTON_WASM_PATH?: string }).__WEBFORGE_PHOTON_WASM_PATH =
