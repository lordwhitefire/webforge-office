import type { Hooks, PluginInput } from "@webforge-ai/plugin"
import type { Model } from "@webforge-ai/sdk/v2"
import { InstallationVersion } from "@webforge-ai/core/installation/version"
import { OauthCallbackPage } from "@webforge-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. WebForge will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
