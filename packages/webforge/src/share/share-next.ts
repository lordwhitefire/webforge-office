...
import type * as SDK from "@webforge-ai/sdk/v2"
...
import { SessionShareTable } from "@webforge-ai/core/share/sql"
...
const disabled = process.env["WEBFORGE_DISABLE_SHARE"] === "true" || process.env["WEBFORGE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@webforge/ShareNext") {}
