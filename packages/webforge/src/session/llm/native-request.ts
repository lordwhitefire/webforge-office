import type { JsonSchema, LLMRequest, ProviderMetadata } from "@webforge-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@webforge-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @webforge-ai/llm request objects from webforge's session/AI SDK-shaped data.
  return LLM.request({
