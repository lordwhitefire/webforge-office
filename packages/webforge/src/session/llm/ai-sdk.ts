import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@webforge-ai/llm"
...
// Move this extraction into @webforge-ai/llm when Copilot is handled by the native runtime.
