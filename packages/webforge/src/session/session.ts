...
import { Slug } from "@webforge-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@webforge-ai/llm"
...
import { locationServiceMapLayer } from "@webforge-ai/core/location-services"
...
import { PartTable, SessionTable } from "@webforge-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@webforge-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".webforge", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@webforge/Session") {}
