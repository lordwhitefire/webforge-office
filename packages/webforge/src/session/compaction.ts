...
import { buildPrompt } from "@webforge-ai/core/session/compaction"
import { SessionCompactionEvent } from "@webforge-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@webforge/SessionCompaction") {}
