...
//
// The saved variant persists across sessions in ~/.local/state/webforge/model.json
...
class Service extends Context.Service<Service, VariantService>()("@webforge/RunVariant") {}
