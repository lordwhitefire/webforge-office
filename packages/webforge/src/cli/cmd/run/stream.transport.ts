...
import type { Event, GlobalEvent, WebforgeClient } from "@webforge-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@webforge/RunStreamTransport") {}
