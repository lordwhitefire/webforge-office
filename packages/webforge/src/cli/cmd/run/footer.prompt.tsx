...
import { normalizePromptContent } from "@webforge-ai/tui/editor"
...
import { WEBFORGE_BASE_MODE, useBindings } from "@webforge-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close WebForge" } satisfies SlashOption,
    ]
