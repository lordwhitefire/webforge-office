...
import { openEditor } from "@webforge-ai/tui/editor"
import { registerWebforgeKeymap } from "@webforge-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerWebforgeKeymap(keymap, renderer, input.tuiConfig)
