...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@webforge/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@webforge/ACPDirectory") {}
