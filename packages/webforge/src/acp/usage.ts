...
import type { AssistantMessage as WebForgeAssistantMessage, Message } from "@webforge-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@webforge-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<WebForgeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<WebForgeAssistantMessage, "role"> &
  Partial<Pick<WebForgeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@webforge/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@webforge/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@webforge/ACPUsage") {}
