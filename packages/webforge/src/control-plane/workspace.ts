...
import { EventSequenceTable, EventTable } from "@webforge-ai/core/event/sql"
...
import { WorkspaceEvent } from "@webforge-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@webforge/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        WEBFORGE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        WEBFORGE_WORKSPACE_ID: config.id,
        WEBFORGE_EXPERIMENTAL_WORKSPACES: "true",
