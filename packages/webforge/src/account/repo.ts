...
import { AccountStateTable, AccountTable } from "@webforge-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@webforge/AccountRepo") {}
