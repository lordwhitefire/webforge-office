...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>WebForge | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="WebForge terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to WebForge. Please read on to learn the rules and restrictions that govern your use of
                WebForge&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("WebForge," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-webforge">What is WebForge?</h2>
              <p>
                WebForge is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the WebForge Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, WebForge enables you to
              ...
              <p>
                WebForge takes the privacy of its users very seriously. For the current WebForge Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using WebForge?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by WebForge;
                </li>
                <li>
              ...
              <p>
                If you use WebForge with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                WebForge. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                WebForge has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-webforge-ever-change-the-services">Will WebForge ever change the Services?</h2>
              <p>
              ...
              <p>
                WebForge is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. WebForge has the sole right to decide whether you are
              ...
              <p>
                WebForge and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (WebForge and all such
                parties together, the "WebForge Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the WebForge Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The WebForge Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY WEBFORGE (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                WEBFORGE PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO WEBFORGE IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the WebForge Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without WebForge's prior written
              ...
              <p>
                ...
                disputes and claims with WebForge and limits the manner in which you can seek relief from WebForge. Both
                you and WebForge acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, WebForge's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. WebForge will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. WebForge will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or WebForge may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND WEBFORGE WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and WebForge are instead choosing to have claims and disputes resolved by
                ...
                you and WebForge over whether to vacate or enforce an arbitration award, YOU AND WEBFORGE WAIVE ALL
              ...
              <p>
                ...
                WebForge is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or WebForge to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and WebForge agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the WebForge may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and WebForge agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and WebForge, and
                ...
                are not an employee, agent, partner, or joint venture of WebForge, and you do not have any authority of
                any kind to bind WebForge in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and WebForge
