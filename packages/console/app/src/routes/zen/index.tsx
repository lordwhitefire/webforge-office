...
import compareVideo from "../../asset/lander/webforge-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/webforge-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="webforge:auth" content={loggedin() ? "true" : "false"} />
